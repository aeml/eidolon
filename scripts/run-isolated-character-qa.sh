...
qa_allowlist+=",${QA_USERNAME_BASE}-duration,${QA_USERNAME_BASE}-forge,${QA_USERNAME_BASE}-whip"
...
docker build \
  ...
  --build-arg "BUILD_VERSION=Alpha 1.0.35" \
