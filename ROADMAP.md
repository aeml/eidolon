...
>
> Current-status pointers refreshed: September 21, 2026
...
- Active implementation line: `Alpha 1.9`, progressing toward the full `1.10.0` beta milestone. Verified live: `1.9.29`, including latest-cleared-boss town-return checkpoints, the enlarged casino/admin-VIP batch, corrected stash placement, service-hint cleanup, encounter-timed Dark King opening, authoritative dungeon re-entry landings and preserved seeded encounter composition on restoration. See the [execution ledger](docs/plans/2026-09-05-roadmap-execution.md) and [final integration audit](docs/plans/2026-09-14-final-integration-audit.md).
- Required remaining campaign scope: approximately100 hours to level100, then8–12 hours of Dark Realm quests/lore through the Nexus and Dark King. A local55-chapter campaign now adds24 Dark Realm chapters and38 discoveries, but is not deployed or pacing-accepted. See the [campaign integration and remaining work](docs/plans/2026-09-21-campaign-pacing-and-dark-realm.md).
- Release candidate1.9.30 contains that expedition, six optional conversational residents and initial incoming-XP tuning. Connected first-expedition and fresh-opening checks passed; this does not close full campaign/raid or duration acceptance. Delivery status remains separate from the candidate's version label.
