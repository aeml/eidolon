...
- The Playwright harness covers anonymous, persistent-character, four-class, all-realm hazard, and two-account flows. The full character route runs locally against disposable Mongo/API containers and live against the exact deployed workflow SHA in hardware-accelerated system Chrome, including multiplayer convergence.
