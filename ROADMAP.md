...
- Release-confidence gate: locked/self-hosted browser dependencies, production SHA/readiness reporting, and real-browser deployment QA are live-verified through release SHA `e56121d`
...
- The Playwright harness covers anonymous, persistent-character, and two-account flows. The full character route passes locally against disposable Mongo/API containers and passed live against deployed SHA `e56121d` in hardware-accelerated system Chrome, including multiplayer convergence.
