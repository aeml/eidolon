...
/**
 * Abyssal Goliath - Abyssal Well Boss 3
 */
export class AbyssalGoliath extends Actor {
    constructor(id) {
        super(id, { STATS: { STRENGTH: 4200, STAMINA: 3800000, DEXTERITY: 200, INTELLIGENCE: 2200, WISDOM: 2200 } });
        this.xpValue = 600000;
        ...
        this.meshType = 'AbyssalGoliath';
        this.name = 'Abyssal Goliath';
        this.isBoss = true;
    }
