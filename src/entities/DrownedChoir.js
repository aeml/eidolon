...
/**
 * Drowned Choir - Abyssal Well Boss 2
 */
export class DrownedChoir extends Actor {
    constructor(id) {
        super(id, { STATS: { STRENGTH: 3300, STAMINA: 3400000, DEXTERITY: 220, INTELLIGENCE: 2300, WISDOM: 2300 } });
        this.xpValue = 500000;
        ...
        this.meshType = 'DrownedChoir';
        this.name = 'Drowned Choir';
        this.isBoss = true;
    }
