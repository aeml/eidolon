...
/**
 * ObsidianGuardian - Molten Core Boss 4
 * DPS Check: Stone Shield at 50% HP must be broken in 20 seconds or party wipe
 * Abilities: Petrify (8s stun, interruptible), Quake (ground pound), Obsidian Spikes
 */
export class ObsidianGuardian extends Actor {
    constructor(id) {
        super(id, { STATS: { STRENGTH: 5000, STAMINA: 5000000, DEXTERITY: 180, INTELLIGENCE: 1800, WISDOM: 1800 } });
        this.xpValue = 800000;
        ...
        this.meshType = 'ObsidianGuardian';
        this.name = 'Obsidian Guardian';
        this.isBoss = true;
    }
