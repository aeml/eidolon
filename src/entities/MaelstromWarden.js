...
/**
 * Maelstrom Warden - Abyssal Well Boss 4
 */
export class MaelstromWarden extends Actor {
    constructor(id) {
        super(id, { STATS: { STRENGTH: 4700, STAMINA: 4500000, DEXTERITY: 260, INTELLIGENCE: 2400, WISDOM: 2400 } });
        this.xpValue = 650000;
        ...
        this.meshType = 'MaelstromWarden';
        this.name = 'Maelstrom Warden';
        this.isBoss = true;
    }
