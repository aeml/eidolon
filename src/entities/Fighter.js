...
export class Fighter extends Actor {
    ...
    spawnVisualEffect(gameEngine, position, color, type) {
        ...
        if (type === "spin") {
            const geometry = new THREE.RingGeometry(0.5, 3.0, 32);
            ...
            // Approximate cone with a flattened cylinder or just a directional burst
            // Let's use a group of particles moving forward
            const count = 5;
