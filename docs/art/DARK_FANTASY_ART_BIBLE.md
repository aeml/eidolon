...
- The Cleric is the sacred counter-silhouette: roughly 4.55 world units tall, upright and athletic in fitted reliquary plate, a narrow armored waist, split wine-red war skirt and cape, long plated legs, a broken-sun diadem, oathmace, and swinging censer. Her open face, swept auburn hair, temple locks, and long side braids must remain identifiable at gameplay distance and around equipped headgear. Lantern gold marks vows and authority while pale spirit green is reserved for the censer flame and restorative magic; pale collars, coifs, long stoles, and bell-shaped burial robes are excluded because they collapse the heroine into a friar silhouette.
...
- The Cleric keeps a confident measured stride, vigilant idle, driven run, mace-and-censer attack, independent chain swing, and kneeling collapse while consuming those same authoritative state names.
