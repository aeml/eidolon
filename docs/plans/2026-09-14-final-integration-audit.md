...
| 1.8 social | Group finder, roles, guild calendar, invitations/readiness/moderation, shared seating; [three connected fresh characters pass recruitment privacy, explicit invitation/acceptance, readiness and token-resume roster recovery](2026-09-14-connected-group-finder-acceptance.md) | Integrated rendered group/raid/casino experience and connected guild-calendar flow; retain accepted recruitment/recovery evidence |
