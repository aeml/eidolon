...
| 1.7 arena | Team elimination, practice/ranked, rating windows, build policy, durable results/season rewards and anti-farming; [four connected clients now pass full ranked2v2 rounds and saved results after login](2026-09-14-connected-arena-acceptance.md) | Rendered team-round/result review and active-match disconnect policy in final cross-feature scope; retain prior financial/idempotency tests rather than recreating a season |
