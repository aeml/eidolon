...
| 1.9 world/casino | Rotating disturbances; public and VIP venue/games; connected public blackjack and EP poker/restart; [connected EP cosmetic purchase/apply/replay/actual restart with unchanged Gold and gear](2026-09-14-connected-cosmetic-vendor-acceptance.md); prior membership/recovery evidence | Earned full public event, remaining connected EP blackjack/slots, integrated stairs/venue experience and busy-floor rendering |
