...
Local candidate, not published. It follows the preserved 1.0.36 source
`90e157973178fcd9907a756d8729248b49c312df`; every earlier queued release must clear
...
Alpha 1.0.32 failed before deployment on browser `ERR_NETWORK_CHANGED`; its one
unchanged failed-job rerun is tracked in [the retained failure](2026-09-07-release32-network-retry.md).
Do not push this candidate or skip 1.0.33–36 because its local checks pass.
