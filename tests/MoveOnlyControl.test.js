...
const setup = (type = 'Forge') => Object.assign(new Harness(), {
...
test.each(['Forge', 'LootDrop', 'Skeleton', 'QuestNPC', 'DwarfSalesman'])('Shift-click walks without interacting with %s', type => {
