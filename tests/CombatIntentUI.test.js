...
describe('Combat intent HUD', () => {
    test('renders target name, distance, status, and previews', () => {
        ...
        expect(document.getElementById('combat-intent-panel').style.display).toBe('block');
        expect(document.getElementById('combat-intent-name').textContent).toBe('Skeleton Archer');
    ...
    test('clearCombatIntent hides the panel and clears text', () => {
        ...
        expect(document.getElementById('combat-intent-panel').style.display).toBe('none');
        expect(document.getElementById('combat-intent-name').textContent).toBe('');
        expect(document.getElementById('combat-intent-preview-basic').textContent).toBe('');
    });
});
