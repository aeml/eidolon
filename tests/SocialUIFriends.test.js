...
describe('desktop party support selection', () => {
    test('raid layout follows roster size and resets when leaving', () => {
        ...
        expect(ui.partyPanel.classList.contains('party-panel--group')).toBe(false);
        ...
        expect(ui.partyPanel.classList.contains('party-panel--group')).toBe(true);
        expect(ui.partyPanel.style.display).toBe('flex');
        ...
        expect(ui.partyPanel.classList.contains('party-panel--group')).toBe(false);
        expect(ui.partyPanel.style.display).toBe('block');
        ui.updateParty(null);
        expect(ui.partyPanel.classList.contains('party-panel--raid')).toBe(false);
        expect(ui.partyPanel.classList.contains('party-panel--group')).toBe(false);
        expect(title.textContent).toBe('PARTY');
