...
describe('version presentation', () => {
    test('advances the login screen to alpha 0.29.33 for the latest shipped spell focus duration sync slice', () => {
        expect(indexHtml).toContain('Alpha 0.29.33');
    });
    ...
    test('includes the latest player-facing patch notes entry for 0.29.33', () => {
    ...
    test('keeps the prior 0.29.32 patch notes entry in history', () => {
