    ...
    test('warm-asset-pack writes per-pack metadata after caching assets', async () => {
        ...
        messageHandler({
            data: {
                ...
                payload: {
                    cacheName: 'eidolon-assets-2026-09-03-29',
                    metadataCacheName: 'eidolon-assets-2026-09-03-29-meta',
                    packName: 'core-models',
                    version: '2026-09-03-29',
                    assets: ['./assets/foo.glb?v=2026-09-03-29', './assets/bar.glb?v=2026-09-03-29']
                }
            },
            waitUntil: (promise) => {
                pending = promise;
