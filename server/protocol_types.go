...
const (
	...
	MsgGetLoadouts        = "get_loadouts"
	MsgSaveLoadout        = "save_loadout"
	MsgApplyLoadout       = "apply_loadout"
	MsgLoadoutResult      = "loadout_result"
	MsgGetWardrobe        = "get_wardrobe"
	MsgCollectAppearances = "collect_appearances"
	MsgSelectAppearance   = "select_appearance"
	MsgWardrobeResult     = "wardrobe_result"
	MsgGetEPWallet        = "get_ep_wallet"
	MsgExchangeGoldForEP  = "exchange_gold_for_ep"
	MsgEPWalletResult     = "ep_wallet_result"
	MsgAbility            = "ability"
	...
	MsgChronicleInspect   = "chronicle_inspect"
	MsgChronicleDiscovery = "chronicle_discovery"
...
type AbilityOriginPayload struct {
	X float64 `json:"x"`
	Z float64 `json:"z"`
}

type AbilityLandingPayload struct {
	X float64 `json:"x"`
	Z float64 `json:"z"`
}
