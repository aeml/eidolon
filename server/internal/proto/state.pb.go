...
func (x *Quest) GetCategory() string {
	if x != nil {
		return x.Category
	}
	return ""
...
func (x *Quest) GetObjectiveText() string {
	if x != nil {
...
type Entity struct {
	...
	// Level-cap requirements exceed signed 32-bit range; keep these as 64-bit
	// integers while values remain exactly representable by browser Numbers.
	Experience    int64 `protobuf:"varint,15,opt,name=experience,proto3" json:"experience,omitempty"`
	MaxExperience int64 `protobuf:"varint,16,opt,name=max_experience,json=maxExperience,proto3" json:"max_experience,omitempty"`
	...
	WeakPointDuration          float32 `protobuf:"fixed32,67,opt,name=weak_point_duration,json=weakPointDuration,proto3" json:"weak_point_duration,omitempty"`
...
func (x *Entity) GetExperience() int64 {
	if x != nil {
		return x.Experience
	}
	return 0
...
func (x *Entity) GetMaxExperience() int64 {
	if x != nil {
...
func (x *Entity) GetWeakPointMarked() bool {
	if x != nil {
		return x.WeakPointMarked
	}
	return false
}

func (x *Entity) GetWeakPointDuration() float32 {
	if x != nil {
		return x.WeakPointDuration
	}
	return 0
}

func (x *Entity) GetMarkWeakness() bool {
	if x != nil {
		return x.MarkWeakness
	}
	return false
}

func (x *Entity) GetMarkWeaknessDuration() float32 {
	if x != nil {
		return x.MarkWeaknessDuration
	}
	return 0
}
...
func (x *Entity) GetTimeWarpDuration() float32 {
	if x != nil {
		return x.TimeWarpDuration
	}
	return 0
}

func (x *Entity) GetGuardianEmbraceDuration() float32 {
	if x != nil {
		return x.GuardianEmbraceDuration
	}
	return 0
}
...
func (x *Entity) GetPoisonDuration() float32 {
	if x != nil {
		return x.PoisonDuration
	}
	return 0
}
...
func (x *Entity) GetPartyId() string {
	if x != nil {
		return x.PartyId
	}
	return ""
...
func (x *Entity) GetSocialStatus() string {
	if x != nil {
...
func (x *Entity) GetGuildId() string {
	if x != nil {
		return x.GuildId
	}
	return ""
...
func (x *Entity) GetGuildTag() string {
	if x != nil {
		return x.GuildTag
	}
	return ""
...
func (x *Entity) GetImpactRadius() float32 {
	if x != nil {
...
const file_state_proto_rawDesc = "" +
	...
	"\baccepted\x18\b \x01(\bR\baccepted\x12\x14\n" +
	...
	"\n" +
	"experience\x18\x0f \x01(\x03R\n" +
	"experience\x12%\n" +
	"\x0emax_experience\x18\x10 \x01(\x03R\rmaxExperience\x12\x12\n" +
	...
	"isCharging\x126\n" +
	"\x17guardian_embrace_active\x183 \x01(\bR\x15guardianEmbraceActive\x126\n" +
	"\x17blessing_resolve_active\x184 \x01(\bR\x15blessingResolveActive\x12<\n" +
	"\x1adivine_intervention_active\x185 \x01(\bR\x18divineInterventionActive\x120\n" +
	"\x14arcane_shield_active\x186 \x01(\bR\x12arcaneShieldActive\x12(\n" +
	...
	"\x11weak_point_marked\x18B \x01(\bR\x0fweakPointMarked\x12.\n" +
	"\x13weak_point_duration\x18C \x01(\x02R\x11weakPointDuration\x12#\n" +
	"\rmark_weakness\x18D \x01(\bR\fmarkWeakness\x124\n" +
	"\x16mark_weakness_duration\x18E \x01(\x02R\x14markWeaknessDuration\x12'\n" +
	"\x0fspirit_duration\x18F \x01(\x02R\x0espiritDuration\x12:\n" +
	"\x19blessing_resolve_duration\x18G \x01(\x02R\x17blessingResolveDuration\x12,\n" +
	"\x12time_warp_duration\x18H \x01(\x02R\x10timeWarpDuration\x12:\n" +
	"\x19guardian_embrace_duration\x18I \x01(\x02R\x17guardianEmbraceDuration\x124\n" +
	...
	"\rstun_duration\x18< \x01(\x02R\fstunDuration\x12%\n" +
	"\x0ebleed_duration\x18= \x01(\x02R\rbleedDuration\x12'\n" +
	"\x0fpoison_duration\x18> \x01(\x02R\x0epoisonDuration\x12!\n" +
	"\fbleed_damage\x18? \x01(\x05R\vbleedDamage\x12#\n" +
	"\rpoison_damage\x18@ \x01(\x05R\fpoisonDamage\x12#\n" +
	"\rslow_duration\x18A \x01(\x02R\fslowDuration\x12#\n" +
