...
type CharacterWellRested struct {
	...
	RemainingSeconds float64 `bson:"remaining_seconds"`
}

// A missing snapshot is a legacy save, not a character with zero resources.
// Keep zero mana and death explicit. Maxima derive from the restored build.
