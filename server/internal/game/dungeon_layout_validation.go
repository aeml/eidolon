...
func assignDungeonRoomHooks(layout *DungeonLayout) {
	...
	for idx := range layout.Rooms {
		// Reward hooks are generated by this pass and may be reassigned. Preserve
		// authored encounter hooks such as an elemental raid's crystal Vigil.
		switch layout.Rooms[idx].Hook {
		case "chest", "shrine", "elite_ambush":
