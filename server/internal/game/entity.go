...
type Entity struct {
	...
	ProjectileTravelLimit    float64         `json:"-"`
	ProjectileTravelDistance float64         `json:"-"`
...
func (e *Entity) RecalculateStats() {
	...
	if e.BerserkerModeActive {
		e.Damage = int(float64(e.Damage) * e.ActiveBerserkerModeMultiplier())
...
func (w *World) GetEntityCopy(id string) *Entity {
	...
	newE := &Entity{
		...
		BerserkerModeEndTime:     e.BerserkerModeEndTime,
		BerserkerModeMultiplier:  e.BerserkerModeMultiplier,
		...
		OwnerID:                  e.OwnerID,
		VelX:                     e.VelX,
		ProjectileTravelLimit:    e.ProjectileTravelLimit,
		ProjectileTravelDistance: e.ProjectileTravelDistance,
		VelZ:                     e.VelZ,
		Radius:                   e.Radius,
...
func (w *World) copyEntity(v *Entity) *Entity {
	...
	e := Entity{
		...
		BerserkerModeMultiplier: v.BerserkerModeMultiplier,
		LastStandActive:         v.LastStandActive,
		LastStandEndTime:        v.LastStandEndTime,
		LastStandMultiplier:     v.LastStandMultiplier,
	...
	case TypeProjectile:
		...
		e.OwnerID = v.OwnerID
		e.VelX = v.VelX
		e.ProjectileTravelLimit = v.ProjectileTravelLimit
		e.ProjectileTravelDistance = v.ProjectileTravelDistance
		e.VelZ = v.VelZ
		e.Radius = v.Radius
	case TypeLoot:
